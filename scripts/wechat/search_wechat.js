...
async function resolveRealUrls(articles) {
  ...
  console.error(`获取到 ${articles.length} 篇文章，开始解析真实 URL...`);
  console.error('注意：搜狗微信有严格的反爬虫机制，可能无法获取真实 URL');
...
/**
 * 将 Date 对象格式化为中国时区的 datetime 字符串
 */
